...
import { ingestUserStories } from "../pipelines/ingestion/userStoryPipeline.js";
...
export async function runUserStoryIngestion(
  ...
  try {
    ...
    const stats = {
      totalFiles: ingestionStats.totalFiles,
      successful: ingestionStats.successful,
      errors: ingestionStats.errors,
      duration: totalDuration,
      embeddingsGenerated: ingestionStats.userStoriesProcessed
    };

    return {
      success: true,
      message: "User story ingestion completed successfully",
      stats,
      ingestionStats // Include detailed ingestion stats
    };
